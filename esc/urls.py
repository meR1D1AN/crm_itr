...
urlpatterns = [
    ...
    path(
        "escalators/<int:pk>/",
        EscDetailView.as_view(),
        name="escalator_detail",
    ),
    path(
    ...
    path(
        "problems/",
        EscProblemListView.as_view(),
        name="problem_list",
    ),
    path(
        "problems/create/<int:pk>/",
        EscProblemCreateView.as_view(),
        name="problem_form",
    ),
    path(
    ...
    path(
        "replaces/",
        EscReplaceList.as_view(),
        name="replace_list",
    ),
    path(
        "replaces/create/<int:pk>/",
        EscReplaceCreateView.as_view(),
        name="replace_form",
    ),
    path(
