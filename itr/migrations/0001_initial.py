            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[
                            ("2/2", "2 дня через 2 дня"),
                            ("1/3", "сутки через трое"),
                            ("5/2", "5 дней рабочих 2 дня выходных"),
                        ],
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[
                            ('ООО ГК "ЛифтСервис"', 'ООО ГК "ЛифтСервис"'),
                            ('ООО "ЦентрСервис"', 'ООО "ЦентрСервис"'),
                            ('ООО Холдинг "ЦентрСервис"', 'ООО Холдинг "ЦентрСервис"'),
                        ],
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        null=True,
                        validators=[
                            django.core.validators.RegexValidator("^\\d{12}$", "ИНН должен состоять из 12 цифр.")
                        ],
                        verbose_name="ИНН",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "salary",
                    models.DecimalField(
                        blank=True, decimal_places=2, default=0, max_digits=10, null=True, verbose_name="Зарплата"
                    ),
                ),
            ],
            options={
