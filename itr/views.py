...
#     #     styles = get_styles()
#     #
#     #     self._setup_worksheet_header(ws, customer, month_name_ru, current_year, days_in_month, styles)
#     #     self._add_workdays_data(ws, customer, current_month, current_year, days_in_month, styles)
#     #     self._add_footer(ws, customer, styles)
#     #
#     #     response = self._create_response(wb, customer, month_name_ru, current_year)
#     #     return response
#     #
#     # def _setup_worksheet_header(self, ws, customer, month_name_ru, current_year, days_in_month, styles,
#     #                             current_month=None):
...
#     #
#     #     # Заголовки дней
#     #     self._add_day_headers(ws, days_in_month, current_year, current_month, styles)
#     #
#     # def _add_day_headers(self, ws, days_in_month, current_year, current_month, styles):
...
#     #
#     # def _add_workdays_data(self, ws, customer, current_month, current_year, days_in_month, styles):
#     #     """Добавление данных о рабочих днях"""
...
#     #         self._add_employee_row(ws, employee, work_days, row, days_in_month, total_shifts_col, styles)
#     #
#     #     self._add_total_row(ws, employee_workdays, row, days_in_month, total_shifts_col, styles)
#     #     self._adjust_column_widths(ws, employee_workdays)
#     #
#     # def _add_employee_row(self, ws, employee, work_days, row, days_in_month, total_shifts_col, styles):
...
#     #         cell.border = styles["thin_border"]
#     #         cell.fill = styles["black_fill"] if day in work_days else styles["white_fill"]
#     #
#     #     # Количество смен
#     #     ws.cell(row=row, column=total_shifts_col, value=len(work_days)).border = styles["thin_border"]
#     #     ws.cell(row=row, column=total_shifts_col).alignment = styles["alignment_center"]
#     #
#     # def _add_total_row(self, ws, employee_workdays, last_row, days_in_month, total_shifts_col, styles):
...
#     #
#     # def _adjust_column_widths(self, ws, employee_workdays):
...
#     #         if col == 1:
#     #             max_length = max(
#     #                 (len(f"{employee.last_name} {employee.first_name}")
#     #                  for employee in employee_workdays.keys()),
#     #                 default=0
#     #             )
#     #         else:
...
#     #
#     # def _add_footer(self, ws, customer, styles):
#     #     """Добавление подвала с подписями"""
#     #     total_row = ws.max_row + 4
#     #
#     #     # Словарь с настройками подписей для разных фирм
#     #     firm_settings = {
#     #         'ООО ГК "ЛифтСервис"': {
#     #             'position': 'Управляющий',
#     #             'signature': '___________________ Г. А. Давбер'
#     #         },
#     #         'ООО "ЦентрСервис"': {
#     #             'position': 'Генеральный директор',
#     #             'signature': '___________________ Д. И. Сычёв'
#     #         },
#     #         'ООО Холдинг "ЦентрСервис"': {
#     #             'position': 'Генеральный директор',
#     #             'signature': '___________________ Д. В. Романов'
#     #         }
#     #     }
#     #
#     #     # Настройка по умолчанию
#     #     settings = firm_settings.get(customer.firm, {
#     #         'position': 'Генеральный директор',
#     #         'signature': '___________________'
#     #     })
#     #
#     #     # Подрядчик
#     #     ws.merge_cells(range_string=f"F{total_row}:P{total_row}")
#     #     ws.cell(row=total_row, column=6, value="Подрядчик:")
#     #     ws.merge_cells(range_string=f"S{total_row}:AB{total_row}")
#     #     ws.cell(row=total_row, column=19, value="Заказчик:")
#     #
#     #     # Должность
#     #     total_row += 1
#     #     ws.merge_cells(range_string=f"F{total_row}:P{total_row}")
#     #     ws.cell(row=total_row, column=6, value=settings['position'])
#     #
#     #     # Название фирмы
#     #     total_row += 1
#     #     ws.merge_cells(range_string=f"F{total_row}:P{total_row}")
#     #     ws.cell(row=total_row, column=6, value=customer.firm)
#     #     ws.merge_cells(range_string=f"S{total_row}:AB{total_row}")
...
#     #     total_row += 2
#     #     ws.merge_cells(range_string=f"F{total_row}:P{total_row}")
#     #     ws.cell(row=total_row, column=6, value=settings['signature'])
#     #     ws.merge_cells(range_string=f"S{total_row}:AB{total_row}")
#     #     ws.cell(row=total_row, column=19, value="___________________ /________________/")
#     #
#     # def _create_response(self, wb, customer, month_name_ru, current_year):
